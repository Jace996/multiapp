...
ORM allows us to implement row-level SaaS data isolation more quickly and securely, and the underlying [jace996/saas](https://github.com/jace996/saas) project supports both [ent](https://entgo.io/) and [gorm](https://gorm.io/index.html).
