...
require (
	...
	github.com/jace996/sessions v1.2.3
...
require (
	...
	github.com/go-kratos/kratos/contrib/log/zap/v2 v2.0.0-20240918015945-e1f5dc42b1e5 // indirect
...
replace (
	github.com/dtm-labs/dtm => github.com/jace996/dtm v0.0.0-20231026165303-b379b7f910b5
	github.com/jace996/multiapp => ../../
)
