...
var file_oidc_api_key_v1_key_proto_rawDesc = []byte{
	...
	0x2f, 0x7b, 0x73, 0x65, 0x74, 0x7d, 0x2f, 0x7b, 0x6b, 0x69, 0x64, 0x7d, 0x42, 0x30, 0x5a, 0x2e,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6a, 0x61, 0x63, 0x65, 0x39,
	0x39, 0x36, 0x2f, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x61, 0x70, 0x70, 0x2f, 0x6f, 0x69, 0x64, 0x63,
	0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6b, 0x65, 0x79, 0x2f, 0x76, 0x31, 0x3b, 0x76, 0x31, 0x62, 0x06,
...
func file_oidc_api_key_v1_key_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_oidc_api_key_v1_key_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_oidc_api_key_v1_key_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_oidc_api_key_v1_key_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_oidc_api_key_v1_key_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_oidc_api_key_v1_key_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_oidc_api_key_v1_key_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_oidc_api_key_v1_key_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_oidc_api_key_v1_key_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_oidc_api_key_v1_key_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_oidc_api_key_v1_key_proto_msgTypes[9].Exporter = func(v any, i int) any {
