...
var file_payment_api_gateway_v1_gateway_proto_rawDesc = []byte{
	...
	0x68, 0x6f, 0x6f, 0x6b, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x6a, 0x61, 0x63, 0x65, 0x39, 0x39, 0x36, 0x2f, 0x6d, 0x75, 0x6c, 0x74, 0x69,
	0x61, 0x70, 0x70, 0x2f, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2f, 0x61, 0x70, 0x69, 0x2f,
...
func file_payment_api_gateway_v1_gateway_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_payment_api_gateway_v1_gateway_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_payment_api_gateway_v1_gateway_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_payment_api_gateway_v1_gateway_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_payment_api_gateway_v1_gateway_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_payment_api_gateway_v1_gateway_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_payment_api_gateway_v1_gateway_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_payment_api_gateway_v1_gateway_proto_msgTypes[6].Exporter = func(v any, i int) any {
