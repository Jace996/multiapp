...
func file_product_api_product_v1_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_product_api_product_v1_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_product_api_product_v1_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Badge); i {
			case 0:
				return &v.state
			case 1:
		...
		file_product_api_product_v1_common_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_product_api_product_v1_common_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_product_api_product_v1_common_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Stock); i {
			case 0:
				return &v.state
			case 1:
		...
		file_product_api_product_v1_common_proto_msgTypes[5].Exporter = func(v any, i int) any {
