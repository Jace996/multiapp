...
func file_product_api_product_v1_product_sku_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_product_api_product_v1_product_sku_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_product_api_product_v1_product_sku_proto_msgTypes[1].Exporter = func(v any, i int) any {
