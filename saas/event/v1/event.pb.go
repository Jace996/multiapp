...
var file_saas_event_v1_event_proto_rawDesc = []byte{
	...
	0x70, 0x70, 0x2f, 0x73, 0x61, 0x61, 0x73, 0x2f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2f, 0x76, 0x31,
...
func file_saas_event_v1_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_saas_event_v1_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_saas_event_v1_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
