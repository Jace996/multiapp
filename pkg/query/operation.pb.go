...
var file_query_operation_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x6c, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x6a, 0x61, 0x63, 0x65, 0x39, 0x39, 0x36, 0x2f, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x61,
	0x70, 0x70, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x3b, 0x71, 0x75, 0x65,
...
func file_query_operation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_query_operation_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_query_operation_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_query_operation_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_query_operation_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_query_operation_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_query_operation_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_query_operation_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_query_operation_proto_msgTypes[7].Exporter = func(v any, i int) any {
