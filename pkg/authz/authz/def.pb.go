...
var file_authz_authz_def_proto_rawDesc = []byte{
	...
	0x6b, 0x67, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x7a, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x7a, 0x3b, 0x61,
...
func file_authz_authz_def_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_authz_authz_def_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_authz_authz_def_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_authz_authz_def_proto_msgTypes[2].Exporter = func(v any, i int) any {
