...
import (
	_ "github.com/jace996/multiapp/pkg/authz/authz"
	_ "github.com/jace996/multiapp/pkg/blob"
	conf "github.com/jace996/multiapp/pkg/conf"
	idp "github.com/jace996/multiapp/pkg/idp"
...
var file_user_private_conf_conf_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x72, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x6a, 0x61, 0x63, 0x65, 0x39, 0x39, 0x36, 0x2f, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x61,
	0x70, 0x70, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x2f,
...
func file_user_private_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_user_private_conf_conf_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_user_private_conf_conf_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Admin); i {
			case 0:
				return &v.state
			case 1:
		...
		file_user_private_conf_conf_proto_msgTypes[2].Exporter = func(v any, i int) any {
